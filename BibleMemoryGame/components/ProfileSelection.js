...
const ProfileSelection = ({ profiles, onProfileSelect, onSaveProfiles }) => {
    ...
    const getAgeGroup = (age) => {
        ...
        if (age >= 8 && age <= 12) return 'advanced';
        return 'intermediate';
    };
    ...
    const createProfile = () => {
        ...
        if (!age || age < 2 || age > 12) {
            Alert.alert('Error', 'Please enter a valid age between 2-12');
            return;
        }
    ...
    const deleteProfile = (profileId) => {
        Alert.alert(
            'Delete Profile',
            'Are you sure you want to delete this profile? All progress will be lost.',
            [
